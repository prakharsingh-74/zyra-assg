...
// Helper function to calculate urgency level dynamically based on new mock data schemas
const calculateUrgency = (
  ...
  // Check if any urgent or high priority task is incomplete AND overdue
  ...
  // Medium triage if there are active tasks or unread messages
...
const getActionCenterHandler = (req: Request, res: Response) => {
  ...
  // Derive unread messages count dynamically from the mockMessages store
